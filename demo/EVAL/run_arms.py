...
def run_arm(arm: str, mdir: str, prefix: str, spk_built: dict,
            log_path: str, cache_dir: str, batch_size: int,
            adapter: str | None = None, prompt_style: str = "e5") -> str | None:
    ...
    if adapter:
        cmd += ["--adapter_model_name", adapter]
    if use_registry:
...
def main() -> None:
    ...
    parser.add_argument("--adapter", type=str, default=None,
                        help="Adapter/checkpoint cho refine_llm (E0: chon checkpoint tren val).")
    parser.add_argument("--prompt_style", type=str, default="e5", choices=["e5", "v4"])
    ...
    for movie in movies:
        ...
        for arm in args.arms:
            ...
            out = run_arm(arm, mdir, args.prefix, spk_built, log_path,
                          ...
                          args.adapter, args.prompt_style)
            if out:
