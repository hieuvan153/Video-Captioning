...
def get_config():
    ...
    parser.add_argument('--model_path', type=str, default="/data/ndloc_bk/ntVan/video_caption/scene_seg/SceneSegmentation-SCRL/output/checkpoint_0099.pth.tar")
    parser.add_argument('--shot_info_path', type=str, 
        default='/data/ndloc_bk/ntVan/video_caption/scene_seg/SceneSegmentation-SCRL/data/demo.v1.json')
    parser.add_argument('--shot_img_path', type=str, default='/data/ndloc_bk/ntVan/video_caption/scene_seg/SceneSegmentation-SCRL/data/shot')
    parser.add_argument('--Type', type=str, default='test', choices=['train','test','val','all'])
